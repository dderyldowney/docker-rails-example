...
```sh
git clone https://github.com/nickjj/docker-rails-example ror_test_app
cd ror_test_app
...
The app is named `ror_test_app` right now but chances are your app will be a different
name. Since the app is already created we'll need to do a find / replace on a
few variants of the string "ror_test_app" and update a few Docker related resources.
